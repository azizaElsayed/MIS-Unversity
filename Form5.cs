    ...
    public partial class Form5 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
          //  try{
            ...
            int v;
            v = Convert.ToInt32(y);
            cmd = new SqlCommand("select nationalId from student where nationalId='" + textBox1.Text + "' and restricted='"+"1"+"'", cn);
            cm = new SqlCommand("select count(*) from registeration where nationalId='" + textBox1.Text + "' and [year]=" + v + " and semester='" + label12.Text + "'", cn);
            cn.Open();
         ...
         dv.Read();
                ...
                {//2
                    ...
                    cn.Close();
                    dr.Close();
                    ci = new SqlCommand("select count(*) from selection where nationalId='" + textBox1.Text + "'", cn);
                    cn.Open();
                    dr = ci.ExecuteReader();
                    dr.Read();
                    ...
                    else
                    {
                        ...
                        double decide = 0;
                        int test = 0;
                        cmd = new SqlCommand("select count(gpa) from totalgpa where nationalid='" + textBox1.Text + "' ", cn);
                        cn.Open();
                        ...
                        if (test != 0)
                        {
                            ...
                            {
                                year = year - 1;
                                cmd = new SqlCommand("exec sumgpa2 where @idofstudent='"+textBox1.Text + "' and year=" + year + " ", cn);
                                cn.Open();
                                dv = cmd.ExecuteReader();
                                dv.Read();
                            ...
                            {
                                seme = "first";
                                cmd = new SqlCommand("select gpa from totalgpa where nationalid='" + textBox1.Text + "' and year=" + year + " and semester='" + seme + "'", cn);
                                cn.Open();
                                dv = cmd.ExecuteReader();
                                dv.Read();
                        ...
                        ca = new SqlCommand("select name from student where nationalId='" + textBox1.Text + "'", cn);
                        cn.Open();
                        dr = ca.ExecuteReader();
                        dr.Read();
                        ...
                        Da = new SqlDataAdapter("exec register @idstudent='" + textBox1.Text + "'", cn);
                        ds = new DataSet();
                        Da.Fill(ds);
                        ...
                        int l;
                        l = Convert.ToInt32(b);
                        cl = new SqlCommand("SELECT materials.MaterialCourseTitle FROM materials INNER JOIN registeration ON Materials.MaterialCode = registeration.MaterialCode where registeration.nationalId='" + textBox1.Text+ "' and registeration.year=" + l + " and registeration.semester='" + label12.Text + "'", cn);
                        cn.Open();
                        dr = cl.ExecuteReader();
                        while (dr.Read())
                        {
            ...
            else
            {
                ...
                if (total >= 14 && total <= 18)
                {
                    ...
                    if (r == DialogResult.Yes)
                    {
                        ...
                        cmd = new SqlCommand(" Delete from registeration where nationalid='" + textBox1.Text + "' and year=" + d + " and semester='" + label12.Text + "'", cn);
                        cn.Open();
                        cmd.ExecuteNonQuery();
                        cn.Close();
                        //remove selection table
                        cl = new SqlCommand("exec remov @idofstudent='" + textBox1.Text + "'", cn);
                        cn.Open();
                        cl.ExecuteNonQuery();
                        cn.Close();
                        //new registeration
                        for (int i = dataGridView1.Rows.Count - 1; i >= 0; i--)
                        {
                            ...
                            {
                                string Course = (string)dataGridView1.Rows[i].Cells[0].Value;
                                cmd = new SqlCommand("exec selecte @course='" + Course + "',@idofstudent='" + textBox1.Text + "',@year=" + d + ",@semester='" + label12.Text + "'", cn);
                                cn.Open();
                                cmd.ExecuteNonQuery();
                                cn.Close();
                            }
