    ...
    public partial class Form3 : Form
    {
       ...
       //   try{
                if (!string.IsNullOrEmpty(textBox4.Text))
         {
            ...
            int v;
            v = Convert.ToInt32(y);
            cmd = new SqlCommand("select name from student where nationalId='" + textBox4.Text + "' and restricted='"+"1"+"'", cn);
            cm = new SqlCommand("select count(*) from registeration where nationalId='" + textBox4.Text + "' and [year]=" + v + " and semester='" + label11.Text + "'", cn);
            cn.Open();
            ...
            if (dr.Read())
            {
                ...
                dv.Close();
                cn.Close();
                ci = new SqlCommand("select count(*) from selection where nationalId='" + textBox4.Text + "'", cn);
                cn.Open();
                dv = ci.ExecuteReader();
                dv.Read();
                ...
                else
                {
                    ...
                    else
                    {
                      ...
                      double decide=0;
                      int test = 0;
                      cmd = new SqlCommand("select count(gpa) from totalgpa where nationalid='" + textBox4.Text + "' ", cn);
                      cn.Open();
                      dv = cmd.ExecuteReader();
                      dv.Read();
                      ...
                      cn.Close();
                        ...
                        {
                            year = year - 1;
                            cmd = new SqlCommand("exec sumgpa2 where @idofstudent='" + textBox4.Text + "' and year="+year+" ", cn);
                            cn.Open();
                            dv = cmd.ExecuteReader();
                            dv.Read();
                        ...
                        {
                            seme = "first";
                            cmd = new SqlCommand("select gpa from totalgpa where nationalid='" + textBox4.Text + "' and year=" + year + " and semester='" + seme + "'", cn);
                            cn.Open();
                            dv = cmd.ExecuteReader();
                            dv.Read();
                        ...
                        Da = new SqlDataAdapter("exec register @idstudent='" + textBox4.Text + "'", cn);
                        ds = new DataSet();
                        Da.Fill(ds);
                        dataGridView1.DataSource = ds.Tables[0];
                        dataGridView2.DataSource = ds.Tables[1];
                        ca = new SqlCommand("select name from student where nationalId='" + textBox4.Text + "' ", cn);
                        cn.Open();
                        dr = ca.ExecuteReader();
                        dr.Read();
    ...
    /*   }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int summ = 0;
             ...
             t = Convert.ToString(total);
                 ...
                 if ((total>=sp) && (total<=sa))
                 {
                     ...
                     {
                         cl = new SqlCommand("exec remov @idofstudent='" + textBox4.Text + "'", cn);
                         cn.Open();
                         cl.ExecuteNonQuery();
                         cn.Close();
                          for(int i=dataGridView1.Rows.Count-1;i>=0;i--)
         {
             ...
             {
                 string Course = (string)dataGridView1.Rows[i].Cells[0].Value;
                 cmd = new SqlCommand("exec selecte @course='" + Course + "',@idofstudent='" + textBox4.Text + "',@year=" + v + ",@semester='" + label11.Text + "'", cn);
                         cn.Open();
                         cmd.ExecuteNonQuery();
                         cn.Close();
             }
                         ...
                         //
                          ...
                          cmd = new SqlCommand("exec inserte3 @idofstudent='" + textBox4.Text + "',@year=" + v + ",@semester='" + label11.Text + "'", cn);
                          cn.Open();
                          cmd.ExecuteNonQuery();
                          cn.Close();
                         //
        ...
        {
            DialogResult r = MessageBox.Show("لم يتم حفظ التعديل فى التسجيل السابق للطالب الحالى", "رسالة", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
            if (r == DialogResult.Yes)
            {
                this.Close();
            }
        ...
        private void button6_Click_1(object sender, EventArgs e)
        {
            ...
            Form4 FrmUpdateAutoRegister = new Form4();
            FrmUpdateAutoRegister.nationalid = textBox4.Text;
            FrmUpdateAutoRegister.textBox1.Text = textBox4.Text;
